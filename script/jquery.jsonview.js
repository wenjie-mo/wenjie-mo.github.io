...
(function(jQuery) {
  ...
  JSONFormatter = (function() {
    ...
    JSONFormatter.prototype.stringToHTML = function(value) {
      ...
      if (/^(http|https|file):\/\/[^\s]+$/i.test(value)) {
        ...
        return "<a href=\"" + (this.htmlEncode(split[0])) + "\"><span class=\"q\">\"</span>" + "\"" + (this.jsString(split[1])) + "\"" + "<span class=\"q\">\"</span></a>";
      } else {
        multilineClass = '';
  ...
  Collapser = (function() {
    ...
    Collapser.bindEvent = function(item, options) {
      ...
      if (options.collapsed) {
        return this.selectCollapse(collapser);
      }
    };
    ...
    Collapser.selectCollapse = function(collapser) {
      if (collapser.parentNode.childNodes[1].childNodes[1] && collapser.parentNode.childNodes[1].childNodes[1].textContent === 'Past Experiences') {
        var ellipsis, target;
        target = this.collapseTarget(collapser);
        if (target.style.display === 'none') {
          return;
  ...
  JSONView = {
    ...
    selectCollapse: function(el) {
      return Collapser.selectCollapse(el);
    }
  };
